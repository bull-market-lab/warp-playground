          ...
          <CardBody>
            <Stack divider={<StackDivider />} spacing="4">
              <Text>
                ...
                there. Be careful, because token in warp account is not locked,
                it is recommended to only withdraw the asset when you do not
                have pending jobs, otherwise pending jobs might fail because you
                ...
                warp account directly. Also warp team is working on a fund
                locker so we do not accidentally withdraw the fund used for any
                pending job.
              </Text>
              <Link
